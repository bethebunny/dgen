...
def test_element_wise_mul():
    ...
    expected = strip_prefix("""
        ...
        |     %24 : Index = 2
        |     %25 : llvm.Int<64> = llvm.mul(%6, %24)
        |     %26 : llvm.Int<64> = llvm.add(%25, %14)
        |     %27 : llvm.Ptr = llvm.gep(%1, %26)
        |     %28 : llvm.Float = llvm.load(%27)
        |     %29 : llvm.Float = llvm.fmul(%23, %28)
        |     %30 : Index = 2
        |     %31 : llvm.Int<64> = llvm.mul(%6, %30)
        |     %32 : llvm.Int<64> = llvm.add(%31, %14)
        |     %33 : llvm.Ptr = llvm.gep(%2, %32)
        |     %34 : Nil = llvm.store(%29, %33)
        |     %35 : Index = 1
        |     %36 : llvm.Int<64> = llvm.add(%14, %35)
        |     %37 : Nil = llvm.br<"loop_header1">()
        |     %38 : Nil = llvm.label<"loop_exit1">()
        |     %39 : Index = 1
        |     %40 : llvm.Int<64> = llvm.add(%6, %39)
