...
def test_transpose():
    ...
    expected = strip_prefix("""
        ...
        |     %14 : index = 3
        |     %15 : i1 = llvm.icmp<"slt">(%13, %14)
        |     %16 : () = llvm.cond_br<"loop_body1", "loop_exit1">(%15)
        |     %17 : () = llvm.label<"loop_body1">()
        |     %18 : index = 3
        |     %19 : i64 = llvm.mul(%5, %18)
        |     %20 : i64 = llvm.add(%19, %13)
        |     %21 : ptr = llvm.gep(%0, %20)
        |     %22 : f64 = llvm.load(%21)
        |     %23 : index = 2
        |     %24 : i64 = llvm.mul(%13, %23)
        |     %25 : i64 = llvm.add(%24, %5)
        |     %26 : ptr = llvm.gep(%1, %25)
        |     %27 : () = llvm.store(%22, %26)
        |     %28 : index = 1
        |     %29 : i64 = llvm.add(%13, %28)
        |     %30 : () = llvm.br<"loop_header1">()
        |     %31 : () = llvm.label<"loop_exit1">()
        |     %32 : index = 1
        |     %33 : i64 = llvm.add(%5, %32)
...
def test_element_wise_mul():
    ...
    expected = strip_prefix("""
        ...
        |     %15 : index = 2
        |     %16 : i1 = llvm.icmp<"slt">(%14, %15)
        |     %17 : () = llvm.cond_br<"loop_body1", "loop_exit1">(%16)
        |     %18 : () = llvm.label<"loop_body1">()
        |     %19 : index = 2
        |     %20 : i64 = llvm.mul(%6, %19)
        |     %21 : i64 = llvm.add(%20, %14)
        |     %22 : ptr = llvm.gep(%0, %21)
        |     %23 : f64 = llvm.load(%22)
        |     %24 : index = 2
        |     %25 : i64 = llvm.mul(%6, %24)
        |     %26 : i64 = llvm.add(%25, %14)
        |     %27 : ptr = llvm.gep(%1, %26)
        |     %28 : f64 = llvm.load(%27)
        |     %29 : f64 = llvm.fmul(%23, %28)
        |     %30 : index = 2
        |     %31 : i64 = llvm.mul(%6, %30)
        |     %32 : i64 = llvm.add(%31, %14)
        |     %33 : ptr = llvm.gep(%2, %32)
        |     %34 : () = llvm.store(%29, %33)
        |     %35 : index = 1
        |     %36 : i64 = llvm.add(%14, %35)
        |     %37 : () = llvm.br<"loop_header1">()
        |     %38 : () = llvm.label<"loop_exit1">()
        |     %39 : index = 1
        |     %40 : i64 = llvm.add(%6, %39)
...
def test_3d_element_wise_add():
    ...
    expected = strip_prefix("""
        ...
        |     %23 : index = 2
        |     %24 : i1 = llvm.icmp<"slt">(%22, %23)
        |     %25 : () = llvm.cond_br<"loop_body2", "loop_exit2">(%24)
        |     %26 : () = llvm.label<"loop_body2">()
        |     %27 : index = 4
        |     %28 : i64 = llvm.mul(%6, %27)
        |     %29 : index = 2
        |     %30 : i64 = llvm.mul(%14, %29)
        |     %31 : i64 = llvm.add(%28, %30)
        |     %32 : i64 = llvm.add(%31, %22)
        |     %33 : ptr = llvm.gep(%0, %32)
        |     %34 : f64 = llvm.load(%33)
        |     %35 : index = 4
        |     %36 : i64 = llvm.mul(%6, %35)
        |     %37 : index = 2
        |     %38 : i64 = llvm.mul(%14, %37)
        |     %39 : i64 = llvm.add(%36, %38)
        |     %40 : i64 = llvm.add(%39, %22)
        |     %41 : ptr = llvm.gep(%1, %40)
        |     %42 : f64 = llvm.load(%41)
        |     %43 : f64 = llvm.fadd(%34, %42)
        |     %44 : index = 4
        |     %45 : i64 = llvm.mul(%6, %44)
        |     %46 : index = 2
        |     %47 : i64 = llvm.mul(%14, %46)
        |     %48 : i64 = llvm.add(%45, %47)
        |     %49 : i64 = llvm.add(%48, %22)
        |     %50 : ptr = llvm.gep(%2, %49)
        |     %51 : () = llvm.store(%43, %50)
        |     %52 : index = 1
        |     %53 : i64 = llvm.add(%22, %52)
        |     %54 : () = llvm.br<"loop_header2">()
        |     %55 : () = llvm.label<"loop_exit2">()
        |     %56 : index = 1
        |     %57 : i64 = llvm.add(%14, %56)
        |     %58 : () = llvm.br<"loop_header1">()
        |     %59 : () = llvm.label<"loop_exit1">()
        |     %60 : index = 1
        |     %61 : i64 = llvm.add(%6, %60)
...
def test_multiply_transpose_inlined():
    ...
    expected = strip_prefix("""
        ...
        |     %85 : index = 2
        |     %86 : i1 = llvm.icmp<"slt">(%84, %85)
        |     %87 : () = llvm.cond_br<"loop_body5", "loop_exit5">(%86)
        |     %88 : () = llvm.label<"loop_body5">()
        |     %89 : index = 2
        |     %90 : i64 = llvm.mul(%76, %89)
        |     %91 : i64 = llvm.add(%90, %84)
        |     %92 : ptr = llvm.gep(%2, %91)
        |     %93 : f64 = llvm.load(%92)
        |     %94 : index = 2
        |     %95 : i64 = llvm.mul(%76, %94)
        |     %96 : i64 = llvm.add(%95, %84)
        |     %97 : ptr = llvm.gep(%37, %96)
        |     %98 : f64 = llvm.load(%97)
        |     %99 : f64 = llvm.fmul(%93, %98)
        |     %100 : index = 2
        |     %101 : i64 = llvm.mul(%76, %100)
        |     %102 : i64 = llvm.add(%101, %84)
        |     %103 : ptr = llvm.gep(%72, %102)
        |     %104 : () = llvm.store(%99, %103)
        |     %105 : index = 1
        |     %106 : i64 = llvm.add(%84, %105)
        |     %107 : () = llvm.br<"loop_header5">()
        |     %108 : () = llvm.label<"loop_exit5">()
        |     %109 : index = 1
        |     %110 : i64 = llvm.add(%76, %109)
