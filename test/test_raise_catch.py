...
# -- ASM round-trip and shape (bare IR — no function wrapper) ---------------
...
def test_catch_ir_shape():
    ...
    final_raise = parse(CATCH_THEN_RAISE)
...
def test_catch_lowered_removes_catch_and_raise():
    ...
    lowered = _lower_catch_only(parse(CATCH_THEN_RAISE))
...
# -- End-to-end: compile + JIT (these need the function wrapper) ------------
